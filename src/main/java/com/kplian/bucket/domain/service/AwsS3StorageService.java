...
@ApplicationScoped
@Named("aws")
@Typed(AwsS3StorageService.class)
public class AwsS3StorageService implements FileStorageService {

    @ConfigProperty(name = "storage.aws.access-key")
    String accessKey;

    @ConfigProperty(name = "storage.aws.secret-key")
    String secretKey;

    @ConfigProperty(name = "storage.aws.region")
    String region;

    @ConfigProperty(name = "storage.aws.endpoint", defaultValue = "https://s3.amazonaws.com")
    String endpoint;
